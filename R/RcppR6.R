...
## Version: 0.2.4
## Hash: 82abc0bc024fdc20d70a4bfedb6eefea
...
.R6_EL4P <-
  R6::R6Class(
    ...
    public=list(
      ...
      addEggs = function(eggs_N, genotype_ix) {
        EL4P__addEggs(self, eggs_N, genotype_ix)
      },
      ...
      get_totLambda = function() {
        EL4P__get_totLambda(self)
      },
