...
## Version: 0.2.4
## Hash: ad73b353cabcd22b5210fe2a6f7612dc
...
##' @md
##' @export
`humanPfMOIcpp` <- function(PfID_init, tInf_init=-1, MOI_init=0, b_init=0.55, c_init=0.15, damID_init=-1, sireID_init=-1, chemoprophylaxis_init=FALSE) {
  humanPfMOIcpp__ctor(PfID_init, tInf_init, MOI_init, b_init, c_init, damID_init, sireID_init, chemoprophylaxis_init)
}
.R6_humanPfMOIcpp <-
  R6::R6Class(
    "humanPfMOIcpp",
    ...
    public=list(
      ...
      get_PfID = function() {
        humanPfMOIcpp__get_PfID(self)
      },
      push_PfID = function(PfID_new) {
        humanPfMOIcpp__push_PfID(self, PfID_new)
      },
      get_tInf = function() {
        humanPfMOIcpp__get_tInf(self)
      },
      push_tInf = function(tInf_new) {
        humanPfMOIcpp__push_tInf(self, tInf_new)
      },
      get_MOI = function() {
        humanPfMOIcpp__get_MOI(self)
      },
      set_MOI = function(MOI_new) {
        humanPfMOIcpp__set_MOI(self, MOI_new)
      },
      get_b = function() {
        humanPfMOIcpp__get_b(self)
      },
      set_b = function(b_new) {
        humanPfMOIcpp__set_b(self, b_new)
      },
      get_c = function() {
        humanPfMOIcpp__get_c(self)
      },
      set_c = function(c_new) {
        humanPfMOIcpp__set_c(self, c_new)
      },
      get_damID = function() {
        humanPfMOIcpp__get_damID(self)
      },
      push_damID = function(damID_new) {
        humanPfMOIcpp__push_damID(self, damID_new)
      },
      get_sireID = function() {
        humanPfMOIcpp__get_sireID(self)
      },
      push_sireID = function(sireID_new) {
        humanPfMOIcpp__push_sireID(self, sireID_new)
      },
      get_chemoprophylaxis = function() {
        humanPfMOIcpp__get_chemoprophylaxis(self)
      },
      set_chemoprophylaxis = function(chemoprophylaxis_new) {
        humanPfMOIcpp__set_chemoprophylaxis(self, chemoprophylaxis_new)
      },
      add_Infection = function(PfID_new, damID_new, sireID_new) {
        humanPfMOIcpp__add_Infection(self, PfID_new, damID_new, sireID_new)
      },
      clear_Infection = function(PfID_ix) {
        humanPfMOIcpp__clear_Infection(self, PfID_ix)
      },
      track_history = function(tEvent, event) {
        humanPfMOIcpp__track_history(self, tEvent, event)
      },
      get_history = function() {
        humanPfMOIcpp__get_history(self)
      }),
    active=list())
...
##' @md
##' @export
`mosquitoPfMOIcpp` <- function(PfID_init, tInf_init=-1, MOI_init=0, damID_init=-1, sireID_init=-1) {
  mosquitoPfMOIcpp__ctor(PfID_init, tInf_init, MOI_init, damID_init, sireID_init)
}
.R6_mosquitoPfMOIcpp <-
  R6::R6Class(
    "mosquitoPfMOIcpp",
    ...
    public=list(
      ...
      get_PfID = function() {
        mosquitoPfMOIcpp__get_PfID(self)
      },
      push_PfID = function(PfID_new) {
        mosquitoPfMOIcpp__push_PfID(self, PfID_new)
      },
      get_tInf = function() {
        mosquitoPfMOIcpp__get_tInf(self)
      },
      push_tInf = function(tInf_new) {
        mosquitoPfMOIcpp__push_tInf(self, tInf_new)
      },
      get_MOI = function() {
        mosquitoPfMOIcpp__get_MOI(self)
      },
      set_MOI = function(MOI_new) {
        mosquitoPfMOIcpp__set_MOI(self, MOI_new)
      },
      get_damID = function() {
        mosquitoPfMOIcpp__get_damID(self)
      },
      push_damID = function(damID_new) {
        mosquitoPfMOIcpp__push_damID(self, damID_new)
      },
      get_sireID = function() {
        mosquitoPfMOIcpp__get_sireID(self)
      },
      push_sireID = function(sireID_new) {
        mosquitoPfMOIcpp__push_sireID(self, sireID_new)
      },
      add_Infection = function(PfID_new, tInf_new, damID_new, sireID_new) {
        mosquitoPfMOIcpp__add_Infection(self, PfID_new, tInf_new, damID_new, sireID_new)
      },
      get_Infection = function(PfID_ix) {
        mosquitoPfMOIcpp__get_Infection(self, PfID_ix)
      },
      get_InfectionEIP = function(incubation) {
        mosquitoPfMOIcpp__get_InfectionEIP(self, incubation)
      }),
    active=list())
...
.R6_MosquitoFemaleHistory <-
  R6::R6Class(
    ...
    public=list(
      ...
      historyInit = function(ix, inPointSet) {
        MosquitoFemaleHistory__historyInit(self, ix, inPointSet)
      },
      ...
      exportBionomics = function() {
        MosquitoFemaleHistory__exportBionomics(self)
      }),
    active=list())
