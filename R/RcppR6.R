...
## Version: 0.2.4
## Hash: f0f2fb685808acfff1c27a2b56a61d1f
...
##' Initialize an EL4P pool inside an aquatic site or for a well-mixed macrosimulation tile. This class is nested inside \code{\link{AquaticSite}} or \code{\link{MacroTile}}.
