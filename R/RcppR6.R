...
## Version: 0.2.4
## Hash: 7eb92445b9ae864fad91271a4b0eb9ac
...
.R6_humanPfSIcpp <-
  R6::R6Class(
    ...
    public=list(
      ...
      get_PfID = function() {
        humanPfSIcpp__get_PfID(self)
      },
      push_PfID = function(PfID_new) {
        humanPfSIcpp__push_PfID(self, PfID_new)
      },
      get_tInf = function() {
        humanPfSIcpp__get_tInf(self)
      },
      push_tInf = function(tInf_new) {
        humanPfSIcpp__push_tInf(self, tInf_new)
      },
      get_b = function() {
        humanPfSIcpp__get_b(self)
      },
      set_b = function(b_new) {
        humanPfSIcpp__set_b(self, b_new)
      },
      get_c = function() {
        humanPfSIcpp__get_c(self)
      },
      set_c = function(c_new) {
        humanPfSIcpp__set_c(self, c_new)
      },
      get_damID = function() {
        humanPfSIcpp__get_damID(self)
      },
      push_damID = function(damID_new) {
        humanPfSIcpp__push_damID(self, damID_new)
      },
      get_sireID = function() {
        humanPfSIcpp__get_sireID(self)
      },
      push_sireID = function(sireID_new) {
        humanPfSIcpp__push_sireID(self, sireID_new)
      },
      get_infected = function() {
        humanPfSIcpp__get_infected(self)
      },
      set_infected = function(infected_new) {
        humanPfSIcpp__set_infected(self, infected_new)
      },
      get_chemoprophylaxis = function() {
        humanPfSIcpp__get_chemoprophylaxis(self)
      },
      set_chemoprophylaxis = function(chemoprophylaxis_new) {
        humanPfSIcpp__set_chemoprophylaxis(self, chemoprophylaxis_new)
      },
      track_history = function(tEvent, event) {
